...
```
The IRFs for this period appear to respond quite differently from the whole sample: no negative impact on inflation or the output gap.

We now condider the period until 2007:
